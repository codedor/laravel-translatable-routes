 ...
 * @method static \Codedor\TranslatableRoutes\LocaleCollection forget(|array $keys)
 ...
 * @method static \Codedor\TranslatableRoutes\LocaleCollection||null pop(int $count = 1)
 ...
 * @method static \Codedor\TranslatableRoutes\LocaleCollection| random(callable|int|null $number = null)
 ...
 * @method static \Codedor\TranslatableRoutes\LocaleCollection||null shift(int $count = 1)
 ...
 * @method static \Codedor\TranslatableRoutes\LocaleCollection skipUntil(|callable $value)
 * @method static \Codedor\TranslatableRoutes\LocaleCollection skipWhile(|callable $value)
 ...
 * @method static \Codedor\TranslatableRoutes\LocaleCollection takeUntil(|callable $value)
 * @method static \Codedor\TranslatableRoutes\LocaleCollection takeWhile(|callable $value)
 ...
 * @method static \Codedor\TranslatableRoutes\LocaleCollection partition(callable||string $key, |string|null $operator = null, |null $value = null)
 * @method static mixed sum(callable|string|null $callback = null)
 * @method static \Codedor\TranslatableRoutes\LocaleCollection| whenEmpty(callable $callback, callable|null $default = null)
 * @method static \Codedor\TranslatableRoutes\LocaleCollection| whenNotEmpty(callable $callback, callable|null $default = null)
 * @method static \Codedor\TranslatableRoutes\LocaleCollection| unlessEmpty(callable $callback, callable|null $default = null)
 * @method static \Codedor\TranslatableRoutes\LocaleCollection| unlessNotEmpty(callable $callback, callable|null $default = null)
 ...
 * @method static \Codedor\TranslatableRoutes\LocaleCollection reject(callable|bool| $callback = true)
