...
* Bump dependabot/fetch-metadata from 2.3.0 to 2.4.0 by @dependabot[bot] in https://github.com/codedor/laravel-translatable-routes/pull/29
* Bump aglipanci/laravel-pint-action from 2.5 to 2.6 by @dependabot[bot] in https://github.com/codedor/laravel-translatable-routes/pull/32
* Bump dependabot/fetch-metadata from 2.4.0 to 2.5.0 by @dependabot[bot] in https://github.com/codedor/laravel-translatable-routes/pull/35
* Update namespace to wotz by @jyrkidn in https://github.com/codedor/laravel-translatable-routes/pull/36
* Bump actions/checkout from 4 to 6 by @dependabot[bot] in https://github.com/codedor/laravel-translatable-routes/pull/34
* Bump stefanzweifel/git-auto-commit-action from 5 to 7 by @dependabot[bot] in https://github.com/codedor/laravel-translatable-routes/pull/33

**Full Changelog**: https://github.com/codedor/laravel-translatable-routes/compare/v1.3.0...v2.0.0
